...
namespace NsEngine
{
	...
	public: //メンバ関数
		...
		inline void AddCollider(NsEngine::BaseCollider* collider)
		{
		...
		/// </summary>
		/// <param name="collider">コライダー</param>
		inline void RemoveCollider(NsEngine::BaseCollider* collider)
		{
	...
	private:
		...
		//コライダーのリスト
		std::forward_list<NsEngine::BaseCollider*> colliders;
	};
}